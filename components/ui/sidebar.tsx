...
import { Clock, FilePlus2, HelpCircle, Home } from "lucide-react";
...
const menuItems = [
  ...
  { label: "Bantuan", icon: HelpCircle, path: "/dashboard/user/bantuan" },
];
    ...
    >
      ...
      {collapsed && (
        <div className="hidden md:flex flex-col items-center justify-center h-20 text-gray-500 text-xs">
          <div className="rotate-90 whitespace-nowrap mb-2 font-medium">
            Menu
          </div>
